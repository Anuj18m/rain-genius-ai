  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-primary-foreground hover:shadow-glow border-0 font-semibold transition-bounce",
        water: "bg-gradient-water text-primary-foreground hover:bg-primary-light shadow-soft hover:shadow-medium",
        eco: "bg-gradient-eco text-success-foreground hover:bg-eco-light shadow-soft hover:shadow-medium",
